...
const App = () => {
  ...
  return (
    <div className="h-screen px-6 py-4 overflow-y-auto">
      <div className="w-full text-center mb-6 relative">
        <div className="inline-block relative w-1/2">
          <input
            ...
            className="w-full h-16 border border-gray-600/40 rounded-tl-lg rounded-tr-lg px-4"
          />
          {
          ...
          <div className="grid grid-cols-5 gap-4">
            {
              products.map((el) => (
                <div
                  className="border border-gray-600/40 p-4 rounded-lg shadow-md flex flex-col items-center justify-center"
                  key={el.id}
                >
